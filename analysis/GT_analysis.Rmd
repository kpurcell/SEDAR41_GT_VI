...
# nbmod is the best performing so step down to it

# NULL MODEL FORM
#nbform=formula(SumCount~ y + wc + cd + sc + bd + d + t + lat + temp |y + wc + cd + sc + bd + d + t + lat + temp )

###Remove water clarity and current variables from mean
nbform3a=formula(SumCount~ y + cd + bd + d + t + lat + temp |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod9=zeroinfl(nbform3a,  dist = "negbin", link = "logit",data=dat)
summary(nbmod9)

nbform3b=formula(SumCount~ y + wc + bd + d + t + lat + temp |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod10=zeroinfl(nbform3b,  dist = "negbin", link = "logit",data=dat)
summary(nbmod10)

###Remove benthic variables from mean
nbform3c=formula(SumCount~ y + wc + cd + d + t + lat + temp |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod11=zeroinfl(nbform3c,  dist = "negbin", link = "logit",data=dat)
summary(nbmod11)

nbform3d=formula(SumCount~ y + wc + cd + bd + t + lat + temp |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod12=zeroinfl(nbform3d,  dist = "negbin", link = "logit",data=dat)
summary(nbmod12)

###Remove depth from mean
nbform3e=formula(SumCount~ y + wc + cd + bd + d + lat + temp |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod13=zeroinfl(nbform3e,  dist = "negbin", link = "logit",data=dat)
summary(nbmod13)

#### Remove Latitude From mean 
nbform3f=formula(SumCount~ y + wc + cd + bd + d + t +  temp |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod14=zeroinfl(nbform3f,  dist = "negbin", link = "logit",data=dat)
summary(nbmod14)

#### Remove Temperature From mean 
nbform3g=formula(SumCount~ y + wc + cd + bd + d + t + lat |y + wc + cd + sc + bd + d + t + lat + temp)
nbmod15=zeroinfl(nbform3g,  dist = "negbin", link = "logit",data=dat)
summary(nbmod15)

lrtest(nbmod9,nbmod3)
lrtest(nbmod10,nbmod3)
lrtest(nbmod11,nbmod3)
lrtest(nbmod12,nbmod3)
lrtest(nbmod13,nbmod3)
lrtest(nbmod14,nbmod3)
lrtest(nbmod15,nbmod3)
AIC(nbmod9)
AIC(nbmod10)
AIC(nbmod11)
AIC(nbmod12)
...
AIC(nbmod3)-AIC(nbmod9)
AIC(nbmod3)-AIC(nbmod10)
AIC(nbmod3)-AIC(nbmod11)
AIC(nbmod3)-AIC(nbmod12)
AIC(nbmod3)-AIC(nbmod13)
AIC(nbmod3)-AIC(nbmod14)
AIC(nbmod3)-AIC(nbmod15)
